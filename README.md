...
The complete collected synthetic dataset is hosted on Google Drive:
...
https://github.com/abdo20050/creating-simulation-dataset-using-blender-addon/raw/main/asset/sample_1_annotated.mp4

> *Note: Annotated video samples are stored in the tracked `asset/` folder (`asset/sample_1_annotated.mp4`).*
